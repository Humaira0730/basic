        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12">
                <div class="logo">
                    ...
                    <a class="theme-color" href="index.html"><i class="fa fa-code"></i>Imagine<i class="fa fa-code"></i></a>
                    <!--== logo ==-->
                </div>
            </div>
...
<div id="home" class="welcome-area"
     style="background-image: url(assets/img/main-bg.jpg); background-attachment: fixed;">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="welcome-text">
                            <h1 class="theme-color">Carlos Ramirez</h1>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="Section1"> <!-- Single Tab -->
                            ...
                            <p>I possess certificates in Web Design, Mobile Development, Java Development, also
                                certified in PEGA CSI (Certified System Architect) and Oracle PL/SQL Certified
                                Professional</p>
                            <ul class="social-links"> <!--=== social-links ===-->
                                ...
                                <li><a href="https://www.linkedin.com/in/carlosramireze/"><i class="fa fa-linkedin"></i></a></li>
                                <!--
            ...
            <div class="col-md-5">
                <div class="single-info"> <!-- Single Info -->
                    ...
                    <div class="info-content">
                        <h5>my location(Temporary):</h5>
                        <p>Av Arequipa 1492, Lima <br> Peru</p>
                    </div>
                </div>
                <div class="single-info"> <!-- Single Info -->
                    <div class="info-icon">
